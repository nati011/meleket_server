...
import (
	...
	"github.com/meleket/server/v2/docs"
	gerror "github.com/meleket/server/v2/error"
...
func Create(db *database.GormDatabase, vInfo *model.VersionInfo, conf *config.Configuration) (*gin.Engine, func()) {
	...
	notificationMessageHandler := api.NotificationMessageAPI{Notifier: notificationHandler, DB: db, ClientDB: db}
	...
	g.Group("/").Use(authentication.RequireApplicationToken()).POST("/notification", notificationMessageHandler.CreateNotificationMessage)
